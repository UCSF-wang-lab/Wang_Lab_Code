...
elseif contains(plot_window_name,'Teensey')
    main_window.UserData.alignment_times(8) = cursor_info.Position(1);
    main_window.UserData.alignment_times_text(8).String = sprintf('Teensey = %7.4f',main_window.UserData.alignment_times(8));
