...
uicontrol('Parent',alignment_tools_panel,...
    ...
    'FontSize',12,...
    'Units','normalized',...
    'Position',[0.505 0.715 0.25 0.12],...
    'Tag','preAlignementTimeText');
...
uicontrol('Parent',alignment_tools_panel,...
    ...
    'FontSize',16,...
    'Units','normalized',...
    'Position',[0.755 0.71 0.235 0.12],...
    'Tag','preAlignementTime',...
    'Callback',@changeAlignmentTime);

uicontrol('Parent',alignment_tools_panel,...
    'Style','text',...
    'BackgroundColor','white',...
    'String',{'Post-alignment'; 'time in sec:'},...
    'FontSize',12,...
    'Units','normalized',...
    'Position',[0.505 0.56 0.25 0.12],...
    'Tag','postAlignmentTimeText');
...
uicontrol('Parent',alignment_tools_panel,...
    ...
    'FontSize',16,...
    'Units','normalized',...
    'Position',[0.755 0.555 0.235 0.12],...
    'Tag','postAlignmentTime',...
    'Callback',@changeAlignmentTime);
...
alignment_times_text(8) = uicontrol('Parent',alignment_tools_panel,...
    ...
    'HorizontalAlignment','left',...
    'BackgroundColor','white',...
    'String',sprintf('Left Rover = %i',nan),...
    'FontSize',14,...
    'Units','normalized',...
    'Position',[0.51 0.11 0.48 0.08]);

alignment_times_text(9) = uicontrol('Parent',alignment_tools_panel,...
    'Style','text',...
    'HorizontalAlignment','left',...
    'BackgroundColor','white',...
    'String',sprintf('Right Rover = %i',nan),...
    'FontSize',14,...
    'Units','normalized',...
    'Position',[0.51 0.02 0.48 0.08]);
