...
% Button to load vicon data
 uicontrol('Parent',main_window,...
    'Style','pushbutton',...
    'BackgroundColor','white',...
    'String','Load Vicon Data',...
    'FontSize',16,...
    'Units','normalized',...
    'Position',[0.03 0.24 0.11 0.05],...
    'Callback',@loadData);

% Button to load delsys data
 uicontrol('Parent',main_window,...
    'Style','pushbutton',...
    'BackgroundColor','white',...
    'String','Load Delsys Data',...
    'FontSize',16,...
    'Units','normalized',...
    'Position',[0.15 0.24 0.11 0.05],...
    'Callback',@loadData);
...
main_window.UserData.Vicon_filename = [];
main_window.UserData.Delsys_filename = [];
end