...
% Astop = 60;
% Apass = 1;
% fs = data.srates(find(strcmp(data.Chan_names,'FSR_adapter_16_Right_FSRA_16')));
% hpSpecs = fdesign.highpass(Fstop_hp,Fpass_hp,Astop,Apass,fs);
% hpf = design(hpSpecs,'cheby2','MatchExactly','stopband'); 
% 
% % Apply the filters
% data.Data.FSR_adapter_16_Right_FSRA_16 = filtfilt(hpf.sosMatrix,hpf.scaleValues,data.Data.FSR_adapter_16_Right_FSRA_16);
...
% RHS_times = data.Time.FSR_adapter_16_Right_FSRA_16((data.Data.FSR_adapter_16_Right_FSRA_16(1:end-1) < 0.4) & (data.Data.FSR_adapter_16_Right_FSRA_16(2:end) > 0.4))';
% LTO_times = data.Time.FSR_adapter_15_Left_FSRD_15((data.Data.FSR_adapter_15_Left_FSRD_15(1:end-1) > 20) & (data.Data.FSR_adapter_15_Left_FSRD_15(2:end) < 20))';
...
% RTO_times = data.Time.FSR_adapter_16_Right_FSRD_16((data.Data.FSR_adapter_16_Right_FSRD_16(1:end-1) > 8) & (data.Data.FSR_adapter_16_Right_FSRD_16(2:end) < 8))';
% RHS_times = data.Time.FSR_adapter_16_Right_FSRA_16((data.Data.FSR_adapter_16_Right_FSRA_16(1:end-1) < 0.1) & (data.Data.FSR_adapter_16_Right_FSRA_16(2:end) > 0.1))';
% LTO_times = data.Time.FSR_adapter_15_Left_FSRD_15((data.Data.FSR_adapter_15_Left_FSRD_15(1:end-1) > 0.3) & (data.Data.FSR_adapter_15_Left_FSRD_15(2:end) < 0.3))';
% LHS_times = data.Time.FSR_adapter_15_Left_FSRA_15((data.Data.FSR_adapter_15_Left_FSRA_15(1:end-1) < 0.3) & (data.Data.FSR_adapter_15_Left_FSRA_15(2:end) > 0.3))';

% % gRCS05--ONmed/ONdbs, dbsOpt
% RTO_times = data.Time.FSR_adapter_16_Right_FSRD_16((data.Data.FSR_adapter_16_Right_FSRD_16(1:end-1) > 0.03) & (data.Data.FSR_adapter_16_Right_FSRD_16(2:end) < 0.03))';
% RHS_times = data.Time.FSR_adapter_16_Right_FSRA_16((data.Data.FSR_adapter_16_Right_FSRA_16(1:end-1) < 5) & (data.Data.FSR_adapter_16_Right_FSRA_16(2:end) > 5))';
% LTO_times = data.Time.FSR_adapter_15_Left_FSRD_15((data.Data.FSR_adapter_15_Left_FSRD_15(1:end-1) > 5) & (data.Data.FSR_adapter_15_Left_FSRD_15(2:end) < 5))';
...
% First sort the gait events
gaitEventTable = sortGaitEvents(gaitEventTable,'RTO');

% Fix the sorted gait event table
% gaitEventTable = fixGaitEvents(gaitEventTable,{'RTO','RHS','LTO','LHS'});
gaitEventTable = fixGaitEvents2(gaitEventTable);
