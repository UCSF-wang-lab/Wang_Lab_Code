function testCondDiffSpectrumGSLT(varargin)
% Tests for differences in spectrum between two task conditions (e.g. hits and misses)
%
% INPUTS:  Optional
...
%           testCondDiffSpectrumGSLT('keys',keys,'saveData',0,'savePlot',0,'comparison','adaptVSmaladapt_right','unilat',0);
%
% Date:     12/22/2023
...
if ~exist('savePlot','var') || isempty(savePlot)
    ...
    plot_save_path = fullfile(parent_dir,'Figures','GSLT_spectrum_figs_adaptive_condDiffs','Merged',comparison);
