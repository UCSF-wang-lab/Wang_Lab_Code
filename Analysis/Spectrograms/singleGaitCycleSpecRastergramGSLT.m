function singleGaitCycleSpecRastergramGSLT(file_names,varargin)
...
marker_colors.RTO = [1 0 0];
marker_colors.LTO = [0 1 0];
marker_colors.RHS = [0 0 1];
marker_colors.LHS = [1 0 1];
...
for f = 1:length(file_names)
    ...
    gait_events_turns_removed = aligned_data.gait_events;
