...
% gRCS04 = {'/Volumes/dwang3_shared/Patient Data/RC+S Data/gait_RCS_04/v3_2022-08-04_pre-programming/Data/Aligned Data/gait_RCS_04_OG_OFF_STIM_OFF_MEDS_Trial1_w_Gait_Events_Julia.mat';...
%     '/Volumes/dwang3_shared/Patient Data/RC+S Data/gait_RCS_04/v3_2022-08-04_pre-programming/Data/Aligned Data/gait_RCS_04_OG_OFF_STIM_ON_MEDS_Trial1_w_Gait_Events_Julia.mat'};
...
elseif strcmp(subjectID,'gRCS03')
    gait_event_range(1) = 0;
    gait_event_range(2) = max(aligned_data.gait_events{end,:});
elseif strcmp(subjectID,'gRCS04')
    gait_event_range(1) = 0;
    gait_event_range(2) = max(aligned_data.gait_events{end,:});
else
    gait_event_range(1) = 0;
