function [data_coherence_table,data_phase_table] = extractDataFeaturesForMLCoherence(files,subject_ID,stim_target,visit_number,varargin)
...
%     3;...                           % gRCS01
%     3;3];                           % gRCS02
% extractDataFeaturesForMLCoherence(patient_files,patient_names,dbs_target,visit_number);
% extractDataFeaturesForMLCoherence(patient_files,patient_names,dbs_target,visit_number,'power_type','peri','adj_time',0.05,'STFT_overlap',0.9);
% extractDataFeaturesForMLCoherence(patient_files,patient_names,dbs_target,visit_number,'power_type','peri','adj_time',0.1,'STFT_overlap',0.9);
% extractDataFeaturesForMLCoherence(patient_files,patient_names,dbs_target,visit_number,'power_type','pre','STFT_overlap',0.9);
